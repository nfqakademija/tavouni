 ...
 */
class Version20171105120048 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE room ADD building_id INT DEFAULT NULL, DROP buildingId');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE room ADD buildingId INT NOT NULL, DROP building_id');
    }
}
